          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-[3rem_1fr_3rem] items-center h-14">
              <button
                type="button"
                onClick={openMenu}
                className="relative z-10 flex items-center justify-center w-10 h-10 -ml-1 rounded-full text-renew-dark hover:bg-gray-50 transition-colors"
              ...
              <Link
                href="/articles"
                className="relative z-10 flex items-center justify-center w-10 h-10 -mr-1 justify-self-end rounded-full text-gray-500 hover:text-renew-dark hover:bg-gray-50 transition-colors"

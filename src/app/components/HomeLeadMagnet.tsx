...
export default function HomeLeadMagnet() {
  ...
  return (
    <section className="py-16 md:py-20 bg-renew-paper border-y border-renew-border">
      <div className="container mx-auto px-4">
        <div className="relative overflow-hidden border border-renew-dark bg-renew-ink text-white shadow-card">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 p-8 md:p-10 lg:p-12 items-center">
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-8">
                <a
                  href={guide.pdfPath}
                  download
                  className="inline-flex items-center justify-center gap-2 bg-renew-accent text-renew-dark font-semibold text-sm px-6 py-3.5 rounded-full hover:bg-white transition-colors"
                >
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-transparent border border-white/20 text-white font-semibold text-sm px-6 py-3.5 rounded-full hover:border-renew-accent hover:text-renew-accent transition-colors"
                >
                  Read online
            ...
            <div className="lg:col-span-5 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-sm">
                <div className="relative bg-renew-paper border border-white/20 shadow-card-hover overflow-hidden text-renew-dark">
                  ...
                  <div className="p-8">
                    ...
                    <p className="mt-4 text-sm text-renew-muted leading-relaxed">{guide.subtitle}</p>
                    <div className="mt-8 pt-6 border-t border-renew-border flex items-center justify-between">
                      <span className="text-xs text-renew-muted">{guide.readTime} read</span>
